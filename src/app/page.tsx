...
function HomeContent() {
  ...
  // Sync category state with URL changes without using an effect that sets state
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <button 
                ...
                className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 rounded-full font-bold flex items-center gap-2 transition-transform hover:scale-105 active:scale-95 shadow-lg shadow-primary/25 cursor-pointer"
              >
          ...
          <div className="flex overflow-x-auto hide-scrollbar pb-2 -mx-4 px-4 md:mx-0 md:px-0 gap-2">
            {CATEGORIES.map(category => (
              <button
                ...
                className={`whitespace-nowrap px-6 py-2.5 rounded-full text-sm font-semibold transition-all cursor-pointer ${
      ...
      <section className="container mx-auto px-4 py-12 mb-16">
        <div className="bg-primary rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between text-primary-foreground relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-lg mb-8 md:mb-0">
            ...
            <button className="bg-white text-primary px-8 py-3 rounded-full font-bold shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
              Claim Offer
            </button>
          </div>
...
export default function Home() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><Loader2 className="animate-spin text-indigo-600" /></div>}>
      <HomeContent />
    </Suspense>
  )
}
